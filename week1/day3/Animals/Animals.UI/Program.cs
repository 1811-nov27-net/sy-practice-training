...
namespace Animals.UI
{
    class Program
    {
        ...
        // camelCase (first letter lower case) for local variables.
        static void Main(string[] args)
        {
            ...
            // using getters and setters with private fields, no reason to do this;
            //    use a property.
            dog.SetWeight(6);
            ...
            // then you can use the same code with multiple implementations of the classes you're using
            DisplayData(new Dog());
