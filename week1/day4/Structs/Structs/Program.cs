...
namespace Structs
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // reference type - only one copy of the string "asdf", with two references to it
            // each variable of a referene type might all be pointing to the same object

            string c = "asdf";
            string d = c; // new reference th the same value.
            ...
            //     this stuff i'm doing right now is inline comments //
