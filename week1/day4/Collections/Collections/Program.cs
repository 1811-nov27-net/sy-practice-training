...
namespace Arrays
{
    class Program
    {
        ...
        static void Arrays()
        {
            ...
            int[] intArray = new int[10]; // length 10 array (brackets not parentheses)
            ...
            int[][] arrayOf4Arrays = new int[4][];
            // this is now an array of four nulls
            // Console.WriteLine(arrayOf4Arrays[0][0]); // exception
            arrayOf4Arrays[0] = new int[3];
            arrayOf4Arrays[0] = new int[300];
            ...
            //  way first, and if necessary later, profile it, and optimize where
            //  actually useful.)
            ...
            // array initialization sytax, length is inferred
        }
        ...
        static void Lists()
        {
            ...
            // so that the actual class should be swapped out later easily.
            ...
            // use this prety much always instead of arrays
        ...
        static void Sets()
        {
            ...
            // sets are very fast o search for a specific value
        ...
        static void StringEquality()
        {
            ...
            // while .Equals is for "refrences an EQUIVALENT object"

            bool stringsEqual = "abc" == "abc";
            Console.WriteLine(stringsEqual);

            // in C#, strings with == compare value, not refernce.
