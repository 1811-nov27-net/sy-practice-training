...
// ES5 has "strict mode"
"use strict";
// strict mode turns certain silent errors into thrown
// errors
...
function Person(name, age) {
    ...
    this.sayJustinsName = obj.sayNameArrow;
}

let person = new Person("Fred", 70);

person.sayName(); // "this" is resolved here, not at
// declaration
person.sayJustinsName(); // "this" was resolved at
// declaration, because it's an arrow function
...
let justin = new Graduate("Justin", 22, 2018);
console.log(justin);
...
let justin2 = new Person2("asdf", 21);
...
// "functional" is another, where functions (hebavior) are
...
/*
 ...
 - arrow functions
 - class, interface
 - method syntax for functions as propertise
...
// string interpolation
console.log("person's name: " + justin.name);
console.log(`person's name: ${justin.name}`); // use `, not
// '
