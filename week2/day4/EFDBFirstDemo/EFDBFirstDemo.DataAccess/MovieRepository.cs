...
namespace EFDBFirstDemo.DataAccess
{
    public class MovieRepository : IMovieRepository
    {
        ...
        // so thecontext knows thats new, and so the DB can auto-generate that IDENTITY value
        ...
        public void EditMovie(Movie movie)
        {
            ...
            // for this way... there can be issues with having multiple tracked entities of the same ID
